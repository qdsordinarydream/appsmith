-- start mongo
    ...
    docker run -d \
				  ...
				  -v /Users/mbj0030/Downloads/temp/mongo:/data/db \
				  mongo --replSet rs0
...
-- 设置环境变量 APPSMITH_MONGODB_URI APPSMITH_REDIS_URI
				export APPSMITH_MONGODB_URI="mongodb://localhost:27017/appsmith" export APPSMITH_REDIS_URL="redis://127.0.0.1:6379" export APPSMITH_MAIL_ENABLED=false export APPSMITH_ENCRYPTION_PASSWORD=abcd export APPSMITH_ENCRYPTION_SALT=abcd
